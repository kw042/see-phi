...
class GoldenRatioApp {
    ...
    initializeElements() {
        ...
        this.goldenCanvas = document.getElementById('goldenCanvas');
    ...
    drawGoldenSpiral(ctx, width, height, isVertical = false) {
        // 黄金長方形から螺旋を描く
        this.drawGoldenSpiralFromRectangles(ctx, width, height, isVertical);
    }
    drawGoldenSpiralFromRectangles(ctx, width, height, isVertical = false) {
        // 黄金長方形の配列を生成
    ...
    drawSquares(ctx, rectangles, isVertical = false) {
    ...
    generateGoldenRectangles(width, height, isVertical = false) {
        const rectangles = [];
        // 最初の黄金長方形（画像全体）
    ...
    cutSquareFromRectangle(rect, iteration, isVertical = false) {
